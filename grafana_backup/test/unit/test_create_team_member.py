...
def test_create_team_member_lookup_by_email(mocker, default_settings, team_member_file, sample_team_member):
    mock_get_user = mocker.patch(
        'grafana_backup.create_team_member.get_user_by_email_or_username',
        return_value=(200, {'id': 123})
    )
    mock_create = mocker.patch(
        'grafana_backup.create_team_member.create_team_member',
        return_value=(200, {})
    )
