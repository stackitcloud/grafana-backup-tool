...
from grafana_backup.dashboardApi import get_grafana_version, search_notification_policies
...
def main(args, settings):
    ...
    if minimum_version <= grafana_version:
        ...
        print(
            'Unable to save notification policies, requires Grafana version {0} '
