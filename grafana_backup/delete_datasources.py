...
from grafana_backup.dashboardApi import delete_datasource_by_id, delete_datasource_by_uid, search_datasource
        ...
        for datasource in datasources:
            ...
            if uid_support:
                status = delete_datasource_by_uid(
                    datasource['uid'], grafana_url, http_get_headers, verify_ssl, client_cert, debug
                )
            else:
                status = delete_datasource_by_id(
                    datasource['id'], grafana_url, http_get_headers, verify_ssl, client_cert, debug
                )
