...
def main(args, settings):
    ...
    get_individual_team_and_delete(teams, pretty_print, grafana_url, http_get_headers, verify_ssl, client_cert, debug)
...
def get_individual_team_and_delete(teams, pretty_print, grafana_url, http_get_headers, verify_ssl, client_cert, debug):
    if teams:
        for team in teams:
            status = delete_team(team['id'], grafana_url, http_get_headers, verify_ssl, client_cert, debug)
