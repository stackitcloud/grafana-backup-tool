# Contributing to `grafana-backup-tool`

Welcome and thank you for making it this far and considering contributing to `grafana-backup-tool`.
...
For major changes, API changes or features please open a [Discussion](https://github.com/stackitcloud/grafana-backup-tool/discussions) or [Issue](https://github.com/stackitcloud/grafana-backup-tool/issues) beforehand to clarify if this is in line with the project and to avoid unnecessary work.
